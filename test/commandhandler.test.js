...
describe('CommandHandler', function () {
  ...
  it('handles br video command', async function () {
    // Arrange
  ...
  it('handles br stats command', async function () {
    // Arrange
  ...
  it('returns an error when br stats goes wrong', async function () {
    // Arrange
  ...
  it('returns an error when br video goes wrong', async function () {
    // Arrange
